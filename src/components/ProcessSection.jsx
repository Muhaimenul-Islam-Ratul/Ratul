...
import { PROCESS_DATA } from '../data/mockData';
  ...
  return (
    <section ref={ref} className="py-24 md:py-36 bg-[#0A0A0A] border-b border-white/10 relative">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        >
          <div>
            <span className="font-mono text-xs text-[#FF4925] tracking-widest uppercase block mb-2">(OUR PROCESS)</span>
          ...
          <p className="font-mono text-xs text-neutral-400 max-w-xs">
            A structured 4-step framework engineered for speed, clarity, and exceptional quality.
          </p>
        </motion.div>
          ...
          {PROCESS_DATA.map((item, index) => {
            ...
            return (
              <motion.div
                key={item.step}
                variants={fadeUp}
                className="group relative bg-white/[0.02] border border-white/10 rounded-3xl p-8 flex flex-col justify-between card-shine"
                whileHover={{
                  y: -10,
                  borderColor: 'rgba(255,73,37,0.5)',
                  boxShadow: '0 0 40px rgba(255,73,37,0.2)',
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-8">
                    <motion.span
                      className="font-anton text-4xl text-[#FF4925]"
                      initial={{ opacity: 0.4 }}
                    ...
                    <motion.div
                      ...
                      whileHover={{ backgroundColor: '#FF4925', borderColor: '#FF4925', rotate: 15 }}
                ...
                <div className="mt-8 pt-4 border-t border-white/5 font-mono text-[10px] text-neutral-500 flex items-center justify-between uppercase">
                  ...
                  <motion.span
                    className="w-2 h-2 rounded-full bg-[#FF4925]"
